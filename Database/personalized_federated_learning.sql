...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 01:59 PM
...
--
-- Database: `personalized_federated_learning`
--
CREATE DATABASE IF NOT EXISTS `personalized_federated_learning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `personalized_federated_learning`;
...
('68fksege1f9u613mw7crmyqkbpmgefat', 'eyJ1c2VyaWQiOjF9:1qxQmb:jkGXa4TeosIom6OepuWUhIXuNhoj_C2gCz1JFxzk0xA', '2023-11-13 11:50:13.508944'),
...
('kl628dbo5c12eefq4485g6pnmk7uvl3d', 'eyJ1c2VyaWQiOjJ9:1qxSGX:tJv3NQgjS1wyGWQqZLYCk4Zq3JOeJLbfmkcQNYg5F3M', '2023-11-13 13:25:13.735146'),
...
('pxxlbwstfg9f0rgbrpxljam7ht29tdpb', 'eyJ1c2VyaWQiOjF9:1qxRIv:hd8rqESQ1eZPMwFl9_Sza3H7s2aLD0L7zkB3Pe5Or7s', '2023-11-13 12:23:37.055039'),
...
(2, 'Manjunath', 'tmksmanju18@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Vijayanagar,ba', 'Male');
...
(11, 'Naive Bayes', '48.728465955701395'),
(12, 'SVM', '49.38474159146842'),
(13, 'Logistic Regression', '49.95898277276456'),
(14, 'Decision Tree Classifier', '50.61525840853158'),
(15, 'SGD Classifier', '49.794913863822806');
...
--
-- Table structure for table `remote_user_mortality_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_mortality_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `PatientId` varchar(300) NOT NULL,
  `ICU_AppointmentID` varchar(300) NOT NULL,
  `Gender` varchar(300) NOT NULL,
  `ScheduledDay` varchar(300) NOT NULL,
  `AppointmentDay` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Scheduled_Doctor` varchar(300) NOT NULL,
  `Scholarship` varchar(300) NOT NULL,
  `Hipertension` varchar(300) NOT NULL,
  `Diabetes` varchar(300) NOT NULL,
  `Alcoholism` varchar(300) NOT NULL,
  `Handcap` varchar(300) NOT NULL,
  `SMS_received` varchar(300) NOT NULL,
  `Patient_Diagnosis` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_mortality_prediction`
--

INSERT INTO `remote_user_mortality_prediction` (`id`, `Fid`, `PatientId`, `ICU_AppointmentID`, `Gender`, `ScheduledDay`, `AppointmentDay`, `Age`, `Scheduled_Doctor`, `Scholarship`, `Hipertension`, `Diabetes`, `Alcoholism`, `Handcap`, `SMS_received`, `Patient_Diagnosis`, `Prediction`) VALUES
(1, '10.42.0.151-10.42.0.1-46697-53-17', '17000', '5534604', 'F', '2022-03-31T16:56:41Z', '2022-04-29T00:00:00Z', '73', 'MARIA ORTIZ', '0', '0', '0', '0', '0', '1', 'No', 'Good'),
(2, '10.42.0.151-10.42.0.1-32711-53-17', '320602', '5557963', 'F', '2022-04-07T15:40:49Z', '2022-04-29T00:00:00Z', '51', 'MARIA ORTIZ', '0', '0', '0', '0', '0', '1', 'No', 'Bad'),
(3, '152.163.56.2-10.42.0.211-443-48457-6', '1263', '5623278', 'F', '2022-04-26T13:48:01Z', '2022-04-29T00:00:00Z', '43', 'TABUAZEIRO', '0', '0', '0', '0', '0', '0', 'No', 'Good'),
(4, '10.42.0.151-98.139.183.24-55392-443-6', '329397', '5629353', 'M', '2022-04-27T13:24:01Z', '2022-04-29T00:00:00Z', '44', 'TABUAZEIRO', '0', '1', '0', '0', '0', '0', 'No', 'Good'),
(5, '172.217.9.227-10.42.0.151-443-57870-6', '60400', '5586620', 'F', '2022-04-15T07:47:46Z', '2022-04-29T00:00:00Z', '6', 'ILHA DO PRÃNCIPE', '1', '0', '0', '0', '0', '1', 'No', 'Bad'),
(6, '10.42.0.211-77.234.44.79-52881-443-6', '38100', '5609936', 'F', '2022-04-20T17:52:20Z', '2022-04-29T00:00:00Z', '33', 'MONTE BELO', '0', '0', '0', '0', '0', '1', 'Yes', 'Bad');
